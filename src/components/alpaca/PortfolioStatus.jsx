                ...
                <>
                    ...
                    <div className="px-3 mb-3">
                        ...
                        <span className={`p-1 fs-3 ${calculatePercentageChange(portfolio.last_equity, portfolio.equity) > 0 ? 'text-success' : 'text-danger'}`}>
                            ...
                            {calculatePercentageChange(portfolio.last_equity, portfolio.equity) > 0 ? <i className="bi bi-arrow-up-short text-success position-absolute"></i> : <i className="bi bi-arrow-down-short text-danger position-absolute"></i>}
                        </span>
                    </div>
                </>
            )}
